...
def get_model_args(args):
    """
    The get_model_args function filters the arguments for only those specific to the 
    model architecture or optimization. (i.e. the ones defined in this file.)
    
    :param args: Pass on any command line arguments to the get_model_args function
    :return: The arguments that are specific to the model architecture and optimization
    :doc-author: Trelent
    """
